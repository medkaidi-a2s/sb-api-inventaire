...
import dz.a2s.a2sinventaire.repositories.views.VenteDetailsRepository;
import dz.a2s.a2sinventaire.repositories.views.VenteZoneDetailsRepository;
import dz.a2s.a2sinventaire.services.CheckingService;
