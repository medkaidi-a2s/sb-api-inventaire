...
import dz.a2s.a2sinventaire.api.AffectationApi;
...
import dz.a2s.a2sinventaire.services.AffectationService;
...
public class AffectationController implements AffectationApi {
    ...
    public ResponseEntity<SuccessResponseDto<List<CommandeZoneResponseDto>>> getListeCmdPrpZone(@RequestParam Optional<String> date) {
        ...
        SuccessResponseDto<List<CommandeZoneResponseDto>> successResponseDto = new SuccessResponseDto<>(200, "Liste des commandes par zone", commandes);
    ...
    public ResponseEntity<SuccessResponseDto<List<CommandeResponseDto>>> getListeCmdPrp(@RequestParam Optional<String> date) {
        ...
        SuccessResponseDto<List<CommandeResponseDto>> successResponseDto = new SuccessResponseDto<>(200, "Liste des commandes à affecter", commandes);
    ...
    public ResponseEntity<SuccessResponseDto<List<CommandeResponseDto>>> getListeCmdAssigned(@RequestParam Optional<String> date) {
        ...
        SuccessResponseDto<List<CommandeResponseDto>> successResponseDto = new SuccessResponseDto<>(200, "Liste des commandes déjà affectées", commandes);
    ...
    public ResponseEntity<SuccessResponseDto<PrpCdePrepCont>> getCmdPrepCont(@RequestParam Integer id, @RequestParam String type, @RequestParam String stkCode) throws Exception {
        ...
        if (id == 0 || type.isEmpty() || stkCode.isEmpty()) throw new Exception("Paramètre manquant ou invalide");

        PrpCdePrepCont prpCdePrepCont = this.affectationService.getPrepCont(id, type, stkCode);

        SuccessResponseDto<PrpCdePrepCont> response = new SuccessResponseDto<>(200, "Préparateur et contrôleurs de la commande", prpCdePrepCont);
    ...
    public ResponseEntity<SuccessResponseDto<List<PrpCmdPrlvDto>>> getListeCmdPrlv(@RequestParam Optional<String> date) {
        ...
        SuccessResponseDto<List<PrpCmdPrlvDto>> successResponseDto = new SuccessResponseDto<>(200, "Liste des commandes à affecter par prélévement", commandes);
    ...
    public ResponseEntity<SuccessResponseDto<List<AffCmdPrlvDto>>> getListCmdPrlvAssigned(@RequestParam Optional<String> date) {
        ...
        SuccessResponseDto<List<AffCmdPrlvDto>> successResponseDto = new SuccessResponseDto<>(200, "Liste des commandes par prélévement déjà affectées", commandes);
    ...
    public ResponseEntity<SuccessResponseDto<PrpCdePrlvPrepCont>> getPrepContPrlv(@RequestParam Integer id, @RequestParam String type, @RequestParam Integer annee) throws Exception {
        ...
        if (id == 0 || type.isEmpty() || annee == 0) throw new Exception("Paramètre manquant ou invalide");
        ...
        SuccessResponseDto<PrpCdePrlvPrepCont> response = new SuccessResponseDto<>(200, "Préparateur et contrôleurs de la commande par prélévement", prpCdePrlvPrepCont);
    ...
    public ResponseEntity<SuccessResponseDto<PrpCdePrlvPrepCont>> editAffectCmdPrpPrlv(@RequestBody @Valid PrpCdePrlvPrepContDto dto) throws Exception {
        ...
        PrpCdePrlvPrepCont prpCdePrlvPrepCont = this.affectationService.editAffectCmdPrpPrlv(dto.getP_cmp(), dto.getP_slt_id(), dto.getP_slt_type(), dto.getP_slt_annee(), dto.getP_prp(), dto.getP_cnt1(), dto.getP_cnt2());

        SuccessResponseDto<PrpCdePrlvPrepCont> response = new SuccessResponseDto<>(200, "Réaffectation effectuée avec succès", prpCdePrlvPrepCont);
    ...
    public ResponseEntity<SuccessResponseDto<PrpCdePrepCont>> editAffectCmdPrp(@RequestBody @Valid AffectCmdRequestDto dto) throws Exception {
        ...
        PrpCdePrepCont prpCdePrlvPrepCont = this.affectationService.editAffectCmdPrp(dto.getP_cmp(), dto.getP_vnt(), dto.getP_stk(), dto.getP_type(), dto.getP_prp(), dto.getP_cnt1(), dto.getP_cnt2());

        SuccessResponseDto<PrpCdePrepCont> response = new SuccessResponseDto<>(200, "Réaffectation effectuée avec succès", prpCdePrlvPrepCont);
    ...
    public ResponseEntity<SuccessResponseDto<ArrayList<AffectCmdResultDto>>> affectCommandePrp(@RequestBody @Valid List<AffectCmdRequestDto> commandes) {
        ...
        commandes.forEach(commande -> {
            AffectCmdResultDto response = this.affectationService.affectCmdPrp(commande.getP_cmp(), commande.getP_vnt(), commande.getP_stk(), commande.getP_type(), commande.getP_prp(), commande.getP_cnt1(), commande.getP_cnt2(), commande.getP_user(), commande.getReference());
    ...
    public ResponseEntity<SuccessResponseDto<ArrayList<AffectCmdResultDto>>> affectCommandePrlv(@RequestBody @Valid List<AffectCmdPrlvReqDto> commandes) {
        ...
        ArrayList<AffectCmdResultDto> tableau = new ArrayList<>();
        commandes.forEach(commande -> {
            AffectCmdResultDto response = this.affectationService.affectCmdPrpPrlv(commande.getP_cmp(), commande.getP_slt_id(), commande.getP_slt_type(), commande.getP_slt_annee(), commande.getP_prp(), commande.getP_cnt1(), commande.getP_cnt2(), commande.getP_user(), commande.getReference());
            tableau.add(response);
        });
        SuccessResponseDto<ArrayList<AffectCmdResultDto>> successResponseDto = new SuccessResponseDto<>(200, "Résultat de l'affectation des commandes", tableau);
        return ResponseEntity.ok(successResponseDto);
    ...
    public ResponseEntity<SuccessResponseDto<List<PrpPrepareControle>>> getAllPreparateurs() {
        ...
        SuccessResponseDto<List<PrpPrepareControle>> successResponseDto = new SuccessResponseDto<>(200, "Liste des préparateurs", preparateurs);
    ...
    public ResponseEntity<SuccessResponseDto<List<PrpPrepareControle>>> getAllControleurs() {
        ...
        SuccessResponseDto<List<PrpPrepareControle>> successResponseDto = new SuccessResponseDto<>(200, "Liste des contrôleurs", controleurs);
